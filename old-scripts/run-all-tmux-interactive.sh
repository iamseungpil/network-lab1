...
echo "=== SDN Lab All-in-One Launcher (Interactive tmux) ==="
echo
...
echo
echo -e "${GREEN}=== SDN Lab Interactive Session (Enhanced tmux) ===${NC}"
echo
...
echo
echo -e "${BLUE}Mininet Commands:${NC}"
echo "- ${YELLOW}pingall${NC}: Test connectivity between all hosts"
echo "- ${YELLOW}h1 ping h11${NC}: Test cross-controller communication"
echo "- ${YELLOW}dump${NC}: Show network information"
echo "- ${YELLOW}links${NC}: Show link information"
echo
...
echo "- ${YELLOW}./run-all-tmux-interactive.sh${NC}: Reconnect to session"
